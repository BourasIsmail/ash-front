...
export function AssocDemPrem() {
  return (
    <>
      <MaxWidthWrapper>
        <main className="w-full py-6 px-16">
          <h1 className="text-2xl">معلومات عن الجمعية</h1>
          <form className=" mx-auto py-6">
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              ...
              <div className="relative z-0 w-full mb-5 group">
                ...
                <select
                  id="underline_select"
                  className="block py-2.5 px-0 w-full text-sm text-gray-500  border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-purple-200 "
                >
                  <option selected>تستفيد اول مرة </option>
